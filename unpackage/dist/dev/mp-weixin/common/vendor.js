...
/***/ 15:
/*!********************************************!*\
  !*** D:/github/myOA/common/ys-validate.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var numberReg = /^-?[1-9][0-9]?.?[0-9]*$/; // 是否为数字
var intReg = /^-?[1-9][0-9]*$/; // 是否为正整数
var phoneReg = /^1[0-9]{10,10}$/; // 手机号
var emailReg = /^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/; // 邮箱
var pwdReg = /^.{6,16}$/; // 密码：6-16位数字
var inviteCodeReg = /^[a-zA-Z0-9]{6,16}$/;
var userReg = /^[A-Za-z0-9]+$/; // 用户名
var _default =
{
      ...
      for (var _iterator = rules[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var rule = _step.value;
        ...
        switch (rule.type) {
          ...
          case 'inviteCode':
            ...
            break;
          case 'user':
            if (!userReg.test(data[rule.name])) {
              res = { isOk: false, errmsg: rule.errmsg };
            }
            break;
...
/***/ 67:
/*!***************************************************!*\
  !*** D:/github/myOA/component/uni-icons/icons.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!**************************************************!*\
  !*** D:/github/myOA/pages.json?{"type":"style"} ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/mine/mine": { "navigationStyle": "custom" }, "pages/message/message": { "navigationStyle": "custom" }, "pages/index/index": { "navigationStyle": "custom" }, "pages/login/login": { "navigationStyle": "custom" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*************************************************!*\
  !*** D:/github/myOA/pages.json?{"type":"stat"} ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__59EC854" };exports.default = _default;
