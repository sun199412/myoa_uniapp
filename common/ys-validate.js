...
const numberReg = /^-?[1-9][0-9]?.?[0-9]*$/								// 是否为数字
const intReg = /^-?[1-9][0-9]*$/  										// 是否为正整数
const phoneReg = /^1[0-9]{10,10}$/ 										// 手机号
const emailReg = /^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/  		// 邮箱
const pwdReg = /^.{6,16}$/  											// 密码：6-16位数字
const inviteCodeReg = /^[a-zA-Z0-9]{6,16}$/
const userReg = /^[A-Za-z0-9]+$/											// 用户名
